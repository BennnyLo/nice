...
<!-- 新闻管理 -->
            <div class="AccountManagement_c" id="NewsManagement_c">
                ...
                <div class="list" id="release_news">
                    ...
                    <form action="Newsaddnews" method="post" enctype="multipart/form-data">
                    <div class="list_b_c" id="release_news_in">
                        <div class="release_news">
                            <div class="news_title">
                                <label class="text_center">标题</label>
                                <input type="text" placeholder="填写标题" name="news.title">
                            </div>
                            ...
                            <div class="news_title">
                                ...
                                <input type="file" placeholder="选择图片" name="upload">
                            </div>
                            <textarea class="release_news_content" rows="50" cols="60" placeholder="编辑正文" name="news.detail"></textarea>     
